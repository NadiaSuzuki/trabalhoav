...
public class ContaResource {
    ...
    public ResponseEntity<List<ContaDTO>> findByUsuario(@PathVariable Long usuarioId) {
        return ResponseEntity.ok().body(contaService.findByUsuario(usuarioId));
    }

    @GetMapping(value = "/banco/{bancoId}")
    public ResponseEntity<List<ContaDTO>> findByBanco(@PathVariable Long bancoId) {
        return ResponseEntity.ok().body(contaService.findByBanco(bancoId));
    }
